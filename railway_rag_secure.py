...
try:
    ...
    logger.warning(f"⚠️ Some features may not work due to missing dependencies: {e}")
...
class HybridVectorStore:
    ...
    def is_available(self) -> bool:
        ...
        return (self.chroma_client is not None and
                ...
                self.docs_collection is not None)
...
def initialize_system():
    ...
    try:
        ...
        try:
            available = hybrid_vector_store.is_available()
            if not available:
...
def main():
    ...
    # System started
    print(f"\n[STARTED] Secure RAG System started on port {os.getenv('PORT', 7860)}")
